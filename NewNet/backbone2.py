...
class MPANet(nn.Module):
    ...
    def __init__(self, in_ch=3, out_ch=1, img_dim=416, patch_dim=13):
        ...
        self.stage6 = ViT(self.vit_img_dim, 512, 512, head_num=4, mlp_dim=512, block_num=8, patch_dim=13)
    ...
    def forward(self, x):
        ...
        # stage 6
        hx6 = self.stage6(hx)
        hx6 = rearrange(hx6, "b (x y) c -> b c x y", x=self.vit_img_dim, y=self.vit_img_dim)
